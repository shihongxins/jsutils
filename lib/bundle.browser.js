(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.StonesJSUtils = {}));
    ...
    function rgb2hex(color = "", alpha = 255) {
        ...
        const colorNumbers = (_a = /\d+(\.\d+)/gm.exec(color)) === null || _a === void 0 ? void 0 : _a.map((n, i) => {
    ...
    function hex2rgb(color = "", alpha = 1) {
        ...
        const fne = !a || isNumberInRange(a, 0, 1) ? `, ${a === null || a === void 0 ? void 0 : a.toFixed(3)})` : ")";
     ...
     * @returns
     */
    function nativeFormat(date = new Date(), format = "YYYY-MM-DD HH:mm:ss") {
     ...
     * @returns
     */
    function dayjsFormat(date = new Date(), format = "YYYY-MM-DD HH:mm:ss") {
     ...
     * @returns
     */
    function durationFormat(from = new Date(), to = new Date(), format = "HH:mm:ss.sss", pad0 = true) {
    ...
    const requestFullscreen = rootElem.requestFullscreen || doc.webkitRequestFullscreen || doc.mozRequestFullScreen || doc.msRequestFullscreen;
     ...
     * @returns
     */
    const createCustomEvent = function (type = "", bubbles = true, cancelable = true) {
        let event;
        if (!type.trim()) {
     ...
     * @returns
     */
    function validateResponseCode(response, code = [], includeStatus = false) {
        return [NaN]
            .concat(code)
            .filter((c) => !isNaN(c))
     ...
     * @returns 合并后的目标对象
     */
    function assignCommonProperty(target = {}, source = {}) {
...
if(typeof window !== 'undefined') {
  window._STONES_JS_UTILS_VERSION_ = '0.0.1'
}
